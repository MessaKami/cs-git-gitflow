...
## 2. Installation et configuration de Git
   - [2.1. Installer Git (Windows, macOS, Linux)](./doc/markdown-git/installation-config.md/#/2.1.)
   - [2.2. Configuration initiale de Git (`git config`)](./doc/markdown-git/installation-config.md/#/2.2.)
